            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav"><br>
                       ...
                       <li> <a class="waves-effect waves-dark" href="../html/medico.html" aria-expanded="false"><i class="fa fa-reply"></i><span class="hide-menu">Anterior</span></a>
                        </li>
              ...
              <div class="table-responsive" id="divConteudo">
                <script>
                  ...
                  var r=confirm("Tem Certeza que deseja Excluir Registro?");
                      ...
                      location.href="Pesquisar_medica.php";
                     }
                  }
              </script>
