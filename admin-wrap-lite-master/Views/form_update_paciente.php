...
<?php
	...
	$id = $_GET['id'];
		...
		$result = $paciente -> buscar_paciente_id($conn, $id);
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="waves-effect waves-dark" href="../Views/Pesquisar_paciente.php" aria-expanded="false"><i class="fa fa-reply"></i><span class="hide-menu">Anterior</span></a>
                        </li>
  ...
  <br> 
	 ...
	 <form method="POST" action="../Controller/Alterar_paciente.php" onsubmit="return validacao();">
  ...
  <div class="form-group col-md-7">
      ...
      <input type="text"  class="form-control" name="nome" id="nome" placeholder="Nome completo" value="<?php echo $row -> nome; ?>" onfocus="this.value='';">
    </div>
    <div class="form-group col-md-3">
      <label><h4>CPF</h4></label>
      <input type="text" class="form-control" name="cpf" id="cpf" value="<?php echo $row -> cpf; ?>" required onfocus="this.value='';" >
    </div>
    </div>

    <div class="form-row">
    <div class="form-group col-md-8">
      <label for="prontuario"><h4>Prontuario do Paciente</h4></label>
      <textarea class="form-control" rows="3" name="prontuario" id="prontuario" value="<?php echo $row -> prontuario; ?>" required onfocus='this.value='';'></textarea>
    </div>
  </div>
   ...
   <div class="form-row">
    ...
    <input type="tel" class="form-control" name="telefone" id="telefone" value="<?php echo $row -> telefone; ?>" required onfocus="this.value='';">
    </div>
    </div>
    <div class="form-row">
  ...
  <div class="form-group col-md-7">
    ...
    <input type="text" class="form-control" name="endereco" id="endereco" required value="<?php echo $row -> endereco; ?>" onfocus="this.value='';">
  </div>
</div>
