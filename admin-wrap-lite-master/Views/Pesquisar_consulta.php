...
<div align="center"><h2>relatorio de consultas</h2></div><br>
<div class="row">
<div class="container">
              ...
              <div id="divConteudo">
                <script>
                  ...
                  var r=confirm("Tem Certeza que deseja Excluir Registro?");
                      ...
                      location.href="Listar_consulta.php";
                     }
                  }
              </script>
...
if(isset($_GET['msg'])){
		...
		include_once '../Model/ConsultaDAO.php';
		...
		$result = $md -> listar_consulta_pac($conn);
		
		echo '
			
			
				<tr class="table-info">	
					<td class> <h4> <b> data da consulta </b> </h4> </td>
					<td> <h4> <b>horario</b> </h4> </td>
					<td> <h4> <b>paciente<b> </h4> </td>
					<td> <h4> <b>medico </b> </h4> </td>
			...
			if ($result) {
				...
				while($row = $result->fetch(PDO::FETCH_OBJ)){
					...
					echo 	
							...
							'<td>'. $row -> nome_med .'</td>'.
							'<td>'. $row -> valor .'</td>'.						
							'<td><a href="../Views/form_update_consulta.php?id='.
							 $row -> id.'"><button class="btn btn-primary btn-custom">
 							<span class="glyphicon glyphicon-pencil"></span>
							</button> </a>'.'</td>'.

							'<td><a href="../Controller/Deletar_consulta.php?id='.
